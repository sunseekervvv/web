...
import com.sunseeker.mall.search.vo.AttrResponseVo;
...
public class SearchServiceImpl implements SearchService {
    ...
    private SearchRequest buildSearchRequest(SearchParam searchParam) {
        ...
        //1.2.2 brand
        String brandId_str = searchParam.getBrandId();
        if (brandId_str!=null) {
            List<String> brandId = Arrays.asList(brandId_str.split("__"));
        ...
        // attrs = 1_5存:8存__2_16G:8G
        String attrs_str = searchParam.getAttrs();
        if (attrs_str!=null) {
            List<String> attrs = Arrays.asList(attrs_str.split("__"));
