      ...
      <div class="mod-config">
        ...
        >
          ...
          <el-table-column prop="valueType" header-align="center" align="center" label="Value type">
            <template slot-scope="scope">
              <el-tag type="success" v-if="scope.row.valueType==0">Radio</el-tag>
              <el-tag v-else>Multi-select</el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="icon" header-align="center" align="center" label="Icon"></el-table-column>
          <el-table-column prop="valueSelect" header-align="center" align="center" label="Select list">
            <template slot-scope="scope">
          ...
          <el-table-column
            ...
            label="Group"
          ></el-table-column>
          <el-table-column v-if="attrtype == 1" prop="showDesc" header-align="center" align="center" label="Quick show">
            <template slot-scope="scope">
