<template>
  <div>
    <el-dialog :close-on-click-modal="false" :visible.sync="visible" @closed="dialogClose">
      <el-dialog width="40%" title="Choose attr" :visible.sync="innerVisible" append-to-body>
        <div>
          ...
          >
            ...
            <el-table-column prop="attrId" header-align="center" align="center" label="Attr id"></el-table-column>
            <el-table-column prop="attrName" header-align="center" align="center" label="Attr name"></el-table-column>
            <el-table-column prop="icon" header-align="center" align="center" label="Attr icon"></el-table-column>
            <el-table-column prop="valueSelect" header-align="center" align="center" label="Select list"></el-table-column>
          </el-table>
          <el-pagination
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="submitAddRealtion">Confirm new</el-button>
        </div>
      </el-dialog>
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column prop="attrName" label="attrName"></el-table-column>
            <el-table-column prop="valueSelect" label="Select list">
    ...
    submitAddRealtion () {
      ...
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          ...
          if (data.code === 0) {
            this.$message({ type: 'success', message: 'New Relation Success' })
          }
