...
export default {
  data () {
    return {
      ...
      dataRule: {
        attrGroupName: [
          { required: true, message: 'Group name NULL', trigger: 'blur' }
        ],
        sort: [{ required: true, message: 'Sort NULL', trigger: 'blur' }],
        descript: [
          { required: true, message: 'Description NULL', trigger: 'blur' }
        ],
        icon: [{ required: true, message: 'Group icon NULL', trigger: 'blur' }],
        catelogId: [
          { required: true, message: 'Category Id NULL', trigger: 'blur' }
        ]
      }
    }
  },
