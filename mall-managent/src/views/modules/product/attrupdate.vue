      ...
      <el-col :span="16">
        <el-card class="box-card">
          ...
          <div style="margin:auto">
            <el-button type="success" style="float:right" @click="submitSpuAttrs">Confirm update</el-button>
          </div>
        </el-card>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    submitSpuAttrs () {
      ...
      this.$confirm('Update modify product attr, continue?', 'Tips', {
