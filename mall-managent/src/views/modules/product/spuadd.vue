    ...
    <el-row>
      <el-col :span="24">
        <el-steps :active="step" finish-status="success">
          <el-step title="Base message"></el-step>
          <el-step title="Base attr"></el-step>
          <el-step title="Sale attr"></el-step>
          <el-step title="SKU message"></el-step>
      ...
      <el-col :span="24" v-show="step===0">
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <el-form ref="spuBaseForm" :model="spu" label-width="120px" :rules="spuBaseInfoRules">
            ...
            <el-form-item label="Integral" prop="bounds">
            ...
            <el-form-item label="Decription" prop="decript">
            ...
            <el-form-item>
              <el-button type="success" @click="collectSpuBaseInfo">Next：Set basic attrs</el-button>
            </el-form-item>
          </el-form>
        </el-card>
      </el-col>
      <el-col :span="24" v-show="step===1">
        <el-card class="box-card" style="width:80%;margin:20px auto">
          ...
          <div style="margin:auto">
            <el-button type="primary" @click="step = 0">Back</el-button>
            <el-button type="success" @click="generateSaleAttrs">Next：Set Sale attrs</el-button>
          </div>
        </el-card>
      </el-col>
      <el-col :span="24" v-show="step===2">
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <el-card class="box-card">
            ...
            <el-button type="primary" @click="step = 1">Back</el-button>
      ...
      <el-col :span="24" v-show="step===3">
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <el-table :data="spu.skus" style="width: 100%">
            <el-table-column label="Attr combination">
              <el-table-column
                :label="item.attrName"
            ...
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-row>
                  <el-col :span="24">
                    <label style="display:block;float:left">Choose imgs Or</label>
                    <multi-upload
                    ...
                    <el-col :span="24">
                      <el-form-item label="Set discount">
                        ...
                        <el-checkbox
                          ...
                          :true-label="1"
                          :false-label="0"
                        >Able to composition</el-checkbox>
                      </el-form-item>
                    </el-col>
                    <el-col :span="24">
          ...
          <el-button type="primary" @click="step = 2">Back</el-button>
      ...
      <el-col :span="24" v-show="step===4">
        <el-card class="box-card" style="width:80%;margin:20px auto">
          <h1>Save success</h1>
          <el-button type="primary" @click="addAgian">Continue to add</el-button>
        </el-card>
      </el-col>
    </el-row>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      spuBaseInfoRules: {
        spuName: [
          { required: true, message: 'Product name NULL', trigger: 'blur' }
        ],
        spuDescription: [
          { required: true, message: 'Description NULL', trigger: 'blur' }
        ],
        catalogId: [
          { required: true, message: 'Category NULL', trigger: 'blur' }
        ],
        brandId: [
          { required: true, message: 'Brand NULL', trigger: 'blur' }
        ],
        decript: [
          { required: true, message: 'Images NULL', trigger: 'blur' }
        ],
        images: [
          { required: true, message: 'Images NULL', trigger: 'blur' }
        ],
  ...
  methods: {
    ...
    submitSkus () {
      ...
      this.$confirm('It will take a short time to submit commodity data. Do you want to continue?', 'Tips', {
        ...
        .then(() => {
          this.$http({
            ...
            if (data.code === 0) {
              ...
              this.$message({
                type: 'error',
                message: 'Failed，Reason【' + data.msg + '】'
              })
            }
          })
        })
