  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item label="Warehouse">
        <el-select style="width:160px;" v-model="dataForm.wareId" placeholder="Choose Warehouse" clearable>
    ...
    >
      ...
      <el-table-column prop="wareId" header-align="center" align="center" label="ware_id"></el-table-column>
      ...
      <el-table-column prop="stockLocked" header-align="center" align="center" label="stock lock"></el-table-column>
