...
<!--        </div>-->
        <div class="login-main">
          <h3 class="login-title">Background login</h3>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          userName: [
            { required: true, message: 'Account NULL', trigger: 'blur' }
          ],
          password: [
            { required: true, message: 'Password NULL', trigger: 'blur' }
          ],
          captcha: [
            { required: true, message: 'CAPTCHA NULL', trigger: 'blur' }
          ]
        },
        captchaPath: ''
      }
